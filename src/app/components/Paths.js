        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-4 bg-white rounded shadow">
            ...
            <p className="text-gray-800">
              Our Mentorship Program provides personalized one-on-one guidance and support to help you achieve your career goals. You'll have access to experienced mentors who will assist you in navigating the complexities of the tech industry and provide valuable insights to enhance your skills.
            </p>
          </div>
          <div className="p-4 bg-white rounded shadow">
